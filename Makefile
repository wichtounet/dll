...
$(eval $(call add_executable,compile_conv_rbm_mp,test_compile/src/compile_conv_rbm_mp.cpp))
$(eval $(call add_executable,compile_dbn,test_compile/src/compile_dbn.cpp))
$(eval $(call add_executable,compile_dyn_dbn,test_compile/src/compile_dyn_dbn.cpp,$(OPENCV_LD_FLAGS)))
$(eval $(call add_executable,compile_dbn_svm,test_compile/src/compile_dbn_svm.cpp,$(LIBSVM_LD_FLAGS)))
$(eval $(call add_executable,compile_conv_dbn,test_compile/src/compile_conv_dbn.cpp))
$(eval $(call add_executable,compile_conv_dbn_mp,test_compile/src/compile_conv_dbn_mp.cpp))
$(eval $(call add_executable,compile_conv_dbn_svm,test_compile/src/compile_conv_dbn_svm.cpp,$(LIBSVM_LD_FLAGS)))

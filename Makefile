...
$(eval $(call add_executable_set,compile,compile_rbm compile_conv_rbm compile_conv_rbm_mp compile_dbn compile_conv_dbn_mp compile_dbn_svm compile_conv_dbn compile_conv_dbn_svm))

...
int main(int argc, char* argv []) {
    ...
    if(sub.empty() || sub == "batch"){
        dll::conv_rbm_desc_square<1, 28, 20, 12, dll::visible<dll::unit_type::GAUSSIAN>, dll::weight_decay<dll::decay_type::L2>, dll::momentum, dll::shuffle, dll::batch_size<25>, dll::weight_type<float>>::layer_t crbm_float;
        dll::conv_rbm_desc_square<1, 28, 20, 12, dll::visible<dll::unit_type::GAUSSIAN>, dll::weight_decay<dll::decay_type::L2>, dll::momentum, dll::shuffle, dll::batch_size<25>, dll::weight_type<double>>::layer_t crbm_double;

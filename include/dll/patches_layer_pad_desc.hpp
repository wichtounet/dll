...
template<std::size_t W_T, std::size_t H_T, std::size_t VS_T, std::size_t HS_T, std::size_t Filler_T>
struct patches_layer_padh_desc {
    ...
    /*! The layer type */
    using layer_t = patches_layer_padh<patches_layer_padh_desc<W_T, H_T, VS_T, HS_T, Filler_T>>;
};

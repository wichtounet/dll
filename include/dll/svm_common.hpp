...
template <typename DBN, typename Result, typename Sample, cpp_enable_iff(dbn_traits<std::decay_t<DBN>>::concatenate())>
...
template <typename DBN, typename Sample, cpp_enable_iff(dbn_traits<std::decay_t<DBN>>::concatenate())>

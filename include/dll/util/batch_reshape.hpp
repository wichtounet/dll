 ...
 */
template<typename Expr, cpp_enable_if(etl::all_fast<Expr>::value && etl::dimensions<Expr>() == 1)>
 ...
 * \return the reshaped expression
 */
template<typename Expr, cpp_enable_if(etl::all_fast<Expr>::value && etl::dimensions<Expr>() == 2)>
decltype(auto) batch_reshape(Expr&& expr){
 ...
 * \return the reshaped expression
 */
template<typename Expr, cpp_enable_if(etl::all_fast<Expr>::value && etl::dimensions<Expr>() == 3)>
decltype(auto) batch_reshape(Expr&& expr){

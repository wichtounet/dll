 ...
 */
template<typename Batch, typename One, cpp_enable_iff(etl::all_fast<Batch, One> && etl::dimensions<One>() == 1)>
 ...
 * \return the extended batchession
 */
template<typename Batch, typename One, cpp_enable_iff(etl::all_fast<Batch, One> && etl::dimensions<One>() == 2)>
decltype(auto) batch_extend(Batch&& batch, One&& one){
    cpp_unused(batch);
    cpp_unused(one);
 ...
 * \return the extended batchession
 */
template<typename Batch, typename One, cpp_enable_iff(etl::all_fast<Batch, One> && etl::dimensions<One>() == 3)>
decltype(auto) batch_extend(Batch&& batch, One&& one){
    cpp_unused(batch);
    cpp_unused(one);

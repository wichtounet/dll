...
struct lstm_layer_desc {
    ...
    /*! The dense type */
    using layer_t = lstm_layer_impl<lstm_layer_desc<TS_T, SL_T, HU_T, Parameters...>>;

    /*! The dense type */
    using dyn_layer_t = lstm_layer_impl<lstm_layer_desc<TS_T, SL_T, HU_T, Parameters...>>;
    //TODO using dyn_layer_t = dyn_lstm_layer_impl<dyn_lstm_layer_desc<Parameters...>>;
    ...
    static_assert(
        detail::is_valid_v<cpp::type_list<
            ...
            Parameters...>,
        "Invalid parameters type for lstm_layer_desc");
};
 ...
 */
template <size_t TS_T, size_t SL_T, size_t HU_T, typename... Parameters>
using lstm_layer = typename lstm_layer_desc<TS_T, SL_T, HU_T, Parameters...>::layer_t;

...
struct dyn_rnn_layer_desc {
    ...
    /*! The dense type */
    using layer_t = dyn_rnn_layer_impl<dyn_rnn_layer_desc<Parameters...>>;
    ...
    static_assert(
        detail::is_valid_v<cpp::type_list<
            ...
            Parameters...>,
        "Invalid parameters type for dyn_rnn_layer_desc");
};
 ...
 */
template <typename... Parameters>
using dyn_rnn_layer = typename dyn_rnn_layer_desc<Parameters...>::layer_t;

...
struct rbm_base : layer<Parent> {
     ...
     */
    template <bool EnableWatcher = true, typename RW = void, typename Generator, typename... Args, cpp_enable_iff(is_generator<Generator>::value)>
     ...
     */
    template <bool EnableWatcher = true, typename RW = void, typename Input, typename... Args, cpp_enable_iff(!is_generator<Input>::value)>

...
struct dyn_shape_1d_layer_desc {
    /*!
    ...
    /*! The layer type */
    using layer_t = dyn_shape_1d_layer_impl<dyn_shape_1d_layer_desc<Parameters...>>;
    ...
    static_assert(
        ...
        "Invalid parameters type for dyn_shape_1d_layer_desc");
};
 ...
 */
template<typename... Parameters>
using dyn_shape_1d_layer = typename dyn_shape_1d_layer_desc<Parameters...>::layer_t;

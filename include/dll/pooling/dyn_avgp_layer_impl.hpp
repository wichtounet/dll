...
struct dyn_avgp_2d_layer_impl final : dyn_pooling_2d_layer<dyn_avgp_2d_layer_impl<Desc>, Desc> {
...
template<typename Desc>
struct layer_base_traits<dyn_avgp_2d_layer_impl<Desc>> {
...
struct sgd_context<DBN, dyn_avgp_2d_layer_impl<Desc>, L> {
 ...
 */
template <typename Desc>
struct dyn_avgp_3d_layer_impl final : dyn_pooling_3d_layer<dyn_avgp_3d_layer_impl<Desc>, Desc> {
    using desc      = Desc;                                  ///< The layer descriptor
    using weight    = typename desc::weight;                 ///< The layer weight type
...
template<typename Desc>
struct layer_base_traits<dyn_avgp_3d_layer_impl<Desc>> {
    static constexpr bool is_neural     = false; ///< Indicates if the layer is a neural layer
    static constexpr bool is_dense      = false; ///< Indicates if the layer is dense
    static constexpr bool is_conv       = false; ///< Indicates if the layer is convolutional
    static constexpr bool is_deconv     = false; ///< Indicates if the layer is deconvolutional
 ...
 */
template <typename DBN, typename Desc, size_t L>
struct sgd_context<DBN, dyn_avgp_3d_layer_impl<Desc>, L> {

...
template<typename Desc>
const std::size_t mp_layer_3d<Desc>::I1;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::I2;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::I3;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::C1;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::C2;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::C3;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::O1;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::O2;

template<typename Desc>
const std::size_t mp_layer_3d<Desc>::O3;

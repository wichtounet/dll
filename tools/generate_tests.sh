...
do
    ...
    echo -e "\t @" './debug/bin/dll_test' "$line >> test_reports/test_$escaped_line.log" >> tests.mk
    echo >> tests.mk

    echo "release_test_$line" ': release_dll_test' >> tests.mk
    echo -e "\t @ echo \"Run $line\" > test_reports/test_$escaped_line.log" >> tests.mk
    echo -e "\t @" './release/bin/dll_test' "$line >> test_reports/test_$escaped_line.log" >> tests.mk
    echo >> tests.mk

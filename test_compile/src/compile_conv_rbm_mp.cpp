...
int main(){
    ...
    typedef dll::conv_rbm_mp<dll::conv_rbm_mp_desc_square<1, 28, 40, 12, 2>> crbm_1;
    ...
    typedef dll::conv_rbm_mp<dll::conv_rbm_mp_desc_square<1, 28, 40, 12, 2, dll::momentum, dll::batch_size<50>>> crbm_2;

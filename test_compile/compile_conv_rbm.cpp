...
int main(){
    ...
    //typedef dll::conv_rbm<dll::conv_rbm_desc_square<dll::conv_conf<true, 50, dll::unit_type::BINARY, dll::unit_type::SIGMOID>, 32, 12, 40>> crbm_1;
    typedef dll::conv_rbm_desc_square<1, 28, 40, 12>::rbm_t crbm_1;
    ...
    typedef dll::conv_rbm_desc_square<1, 28, 40, 12, dll::momentum, dll::batch_size<50>>::rbm_t crbm_2;

...
TEST_CASE("unit/dense/sgd/9", "[unit][dense][dbn][mnist][sgd]") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            dll::dense_desc<28 * 28, 100, dll::activation<dll::function::SIGMOID>>::layer_t,
            dll::dense_desc<100, 10, dll::activation<dll::function::SOFTMAX>>::layer_t>,
        dll::momentum, dll::weight_decay<>, dll::trainer<dll::sgd_trainer>, dll::batch_size<10>, dll::scale_pre<255>>::dbn_t dbn_t;
...
TEST_CASE("unit/dense/sgd/12", "[unit][dense][dbn][mnist][sgd]") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            dll::dense_desc<28 * 28, 150>::layer_t,
            dll::dense_desc<150, 10>::layer_t>,
        dll::trainer<dll::sgd_trainer>, dll::lr_driver<dll::lr_driver_type::BOLD>, dll::batch_size<10>>::dbn_t dbn_t;
...
TEST_CASE("unit/dense/sgd/13", "[unit][dense][dbn][mnist][sgd]") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            dll::dense_desc<28 * 28, 150>::layer_t,
            dll::dense_desc<150, 10>::layer_t>,
        dll::trainer<dll::sgd_trainer>, dll::lr_driver<dll::lr_driver_type::STEP>, dll::batch_size<10>, dll::normalize_pre>::dbn_t dbn_t;

...
DLL_TEST_CASE("unit/conv/sgd/1", "[conv][dbn][mnist][sgd]") {
    ...
    FT_CHECK_DATASET(30, 9e-2);
    TEST_CHECK_DATASET(0.35);
}
...
DLL_TEST_CASE("unit/conv/sgd/3", "[unit][conv][dbn][mnist][sgd]") {
    typedef dll::dbn_desc<
        ...
        dll::trainer<dll::sgd_trainer>, dll::updater<dll::updater_type::SGD>, dll::batch_size<20>, dll::no_batch_display>::dbn_t dbn_t;
...
DLL_TEST_CASE("unit/conv/sgd/4", "[unit][conv][dbn][mnist][sgd]") {
    typedef dll::dbn_desc<
        ...
        dll::trainer<dll::sgd_trainer>, dll::batch_size<20>, dll::scale_pre<255>, dll::no_batch_display>::dbn_t dbn_t;
...
DLL_TEST_CASE("unit/conv/sgd/5", "[conv][dbn][mnist][sgd]") {
    typedef dll::dbn_desc<
        ...
        dll::trainer<dll::sgd_trainer>, dll::batch_size<20>, dll::no_batch_display>::dbn_t dbn_t;

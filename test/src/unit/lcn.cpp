...
TEST_CASE("unit/cdbn/lcn/mnist/2", "[cdbn][lcn][svm][unit]") {
    using dbn_t =
        dll::dbn_desc<dll::dbn_layers<
            ...
            , dll::conv_rbm_desc_square<20, 12, 20, 3, dll::visible<dll::unit_type::GAUSSIAN>, dll::momentum, dll::batch_size<10>>::layer_t
        >>::dbn_t;
...
TEST_CASE("unit/cdbn/lcn/mnist/6", "[cdbn][lcn][unit]") {
    using dbn_t =
        dll::dbn_desc<dll::dbn_layers<
            ...
            , dll::conv_rbm_desc_square<20, 6, 20, 3, dll::momentum, dll::batch_size<10>>::layer_t

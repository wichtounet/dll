...
struct dbn_double {
    using dbn_t =
        dll::dbn_desc<
            dll::dbn_layers<
                dll::rbm_desc<28 * 28, 200, dll::weight_type<double>>::layer_t,
                dll::rbm_desc<200, 10, dll::weight_type<double>>::layer_t
            >
...
struct dbn_float {
    using dbn_t =
        dll::dbn_desc<
            dll::dbn_layers<
                dll::rbm_desc<28 * 28, 200, dll::weight_type<float>>::layer_t,
                dll::rbm_desc<200, 10, dll::weight_type<float>>::layer_t
            >
            , dll::trainer<dll::sgd_trainer>
            , dll::batch_size<10>
            , dll::updater<dll::updater_type::MOMENTUM>

...
DLL_TEST_CASE("unit/dyn_rbm/mnist/1", "[rbm][dyn][momentum][unit]") {
    dll::dyn_rbm_desc<
...
DLL_TEST_CASE("unit/dyn_rbm/mnist/2", "[rbm][dyn][gaussian][momentum][unit]") {
    dll::dyn_rbm_desc<
...
DLL_TEST_CASE("unit/dyn_rbm/mnist/3", "[rbm][dyn][relu][momentum][unit]") {
    dll::dyn_rbm_desc<

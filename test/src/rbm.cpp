...
TEST_CASE("rbm/mnist_40", "rbm::decay_l1") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::weight_decay<dll::decay_type::L1>>::rbm_t rbm;
...
TEST_CASE("rbm/mnist_41", "rbm::decay_l2") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::weight_decay<dll::decay_type::L2>>::rbm_t rbm;
...
TEST_CASE("rbm/mnist_42", "rbm::decay_l1l2") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::weight_decay<dll::decay_type::L1L2>>::rbm_t rbm;
...
TEST_CASE("rbm/mnist_43", "rbm::decay_l1l2_full") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::weight_decay<dll::decay_type::L1L2_FULL>>::rbm_t rbm;
...
TEST_CASE("rbm/mnist_8", "rbm::softmax") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::hidden<dll::unit_type::SOFTMAX>>::rbm_t rbm;
...
TEST_CASE("rbm/mnist_19", "rbm::simple_double") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::weight_type<double>>::rbm_t rbm;
...
TEST_CASE("rbm/mnist_20", "rbm::simple_float") {
    dll::rbm_desc<
        28 * 28, 100,
        dll::batch_size<25>,
        dll::weight_type<float>>::rbm_t rbm;

...
TEST_CASE("conv_dbn_mp/mnist_1", "conv_dbn::simple") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            dll::conv_rbm_mp_desc_square<1, 28, 40, 12, 2, dll::momentum, dll::batch_size<25>>::rbm_t,
            dll::conv_rbm_mp_desc_square<40, 6, 20, 4, 2, dll::momentum, dll::batch_size<25>>::rbm_t>>::dbn_t dbn_t;
...
TEST_CASE("conv_dbn_mp/mnist_2", "conv_dbn::svm_simple") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            dll::conv_rbm_mp_desc_square<1, 28, 40, 18, 2, dll::momentum, dll::batch_size<25>>::rbm_t,
            dll::conv_rbm_mp_desc_square<40, 9, 40, 6, 2, dll::momentum, dll::batch_size<25>>::rbm_t>>::dbn_t dbn_t;
...
TEST_CASE("conv_dbn_mp/mnist_3", "conv_dbn::svm_concatenate") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            dll::conv_rbm_mp_desc_square<1, 28, 40, 18, 2, dll::momentum, dll::batch_size<25>>::rbm_t,
            dll::conv_rbm_mp_desc_square<40, 9, 40, 6, 2, dll::momentum, dll::batch_size<25>>::rbm_t>,
...
TEST_CASE("conv_dbn_mp/mnist_slow", "[cdbn][slow][benchmark]") {
    typedef dll::dbn_desc<
        dll::dbn_layers<
            ...
            dll::conv_rbm_mp_desc_square<40, 8, 40, 4, 2, dll::momentum, dll::batch_size<25>>::rbm_t>>::dbn_t dbn_t;

...
TEST_CASE( "conv_dbn_mp/mnist_1", "conv_dbn::simple" ) {
    typedef dll::dbn_desc<
        dll::dbn_layers<
        dll::conv_rbm_mp_desc_square<28, 1, 12, 40, 2, dll::momentum, dll::batch_size<25>>::rbm_t,
        dll::conv_rbm_mp_desc_square<6, 40, 4, 20, 2, dll::momentum, dll::batch_size<25>>::rbm_t
    >>::dbn_t dbn_t;
...
TEST_CASE( "conv_dbn_mp/mnist_2", "conv_dbn::svm_simple" ) {
    typedef dll::dbn_desc<
        dll::dbn_layers<
        dll::conv_rbm_mp_desc_square<28, 1, 18, 40, 2, dll::momentum, dll::batch_size<25>>::rbm_t,
        dll::conv_rbm_mp_desc_square<9, 40, 6, 40, 2, dll::momentum, dll::batch_size<25>>::rbm_t
    >>::dbn_t dbn_t;
